...
class BackupService:
    """
    Core backup and restore service for clone.
    ...
    def __init__(self):
        ...
        self.agent_zero_root = files.get_abs_path("")  # Resolved clone root
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes clone project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up clone root path with the current clone root path
