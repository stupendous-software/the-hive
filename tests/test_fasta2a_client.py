...
def print_troubleshooting():
    ...
    print("   - Make sure clone is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ clone server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to clone server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start clone server if not running")
