...
# ![Agent Zero Logo](/a0/docs/res/the-hive-logo.png) Agent Zero (The Hive)
...
<div style="display: flex; align-items: center; justify-content: center; margin: 2rem 0;">
  <img src="/a0/docs/res/stupendous-software-logo.png" alt="Stupendous Software" style="height: 60px; margin-right: 2rem;" />
  <img src="/a0/docs/res/the-hive-logo.png" alt="The Hive" style="height: 60px; margin-left: 2rem;" />
</div>
